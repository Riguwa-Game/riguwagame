...
import { rand, choose, random, TAU } from './util.js';
...
function buildMexico(B, arena = false) {
  ...
  for (const [x, z] of [[-33, -14], [-33, -12.6], [-33, -6], [-33, 10], [-33, 20], [33, -12], [33, -3], [33, 6], [33, 22], [-6, 30], [6, 30], [-18, 31], [18, 31], [-3, -33], [3, -33]]) pot(x, z, random() < 0.3);
